...
const LISTINGS = [
  {
    ...
    dureeMin: 3,
    description:
      'Studio entièrement meublé avec cuisine équipée, wifi haut débit et gardien 24h. Idéal pour étudiant.',
    amenities: ['WiFi', 'Cuisine', 'Gardien', 'Parking'],
    particularites: [
      'Entièrement meublé',
      'Climatisation',
      '3e étage avec ascenseur',
      'Eau & électricité incluses',
    ],
  ...
  },
  {
    ...
    dureeMin: 3,
    description:
      "Chambre dans une colocation étudiante conviviale. Salon partagé, cuisine commune, à 5 min à pied de l'UCAD.",
  ...
  },
  {
    ...
    dureeMin: 6,
    description:
      'Bel appartement F3 rénové en 2024 avec balcon. Quartier résidentiel calme, parking privé.',
  ...
  },
  {
    ...
    dureeMin: 3,
    description:
      'Petit studio fonctionnel, idéal pour un premier logement étudiant. Proche commerces et transports.',
...
const SCHOOLS = [
  {
    id: 1,
    name: 'UCAD',
    full: 'Université Cheikh Anta Diop',
    district: 'Fann',
    students: '95 000',
    founded: 1957,
    hue: 220,
    ...
    website: 'ucad.edu.sn',
    email: 'admission@ucad.edu.sn',
    whatsapp: '+221771000101',
    phone: '+221338249000',
    frais: '50 000 – 150 000 CFA/an',
    filieres: ['Médecine', 'Droit', 'Sciences', 'Lettres', 'Économie', 'Informatique', 'Pharmacie'],
    admission: [
      'Bac + dossier scolaire',
      'Concours spécifiques par faculté',
      'Inscription sur plateforme UCAD en ligne',
      'Dossier : relevé de notes, attestation bac, photos',
    ],
  ...
  },
  {
    id: 2,
    name: 'IAM',
    full: 'Institut Africain de Management',
    district: 'Sacré-Cœur',
    students: '4 500',
    founded: 1996,
    hue: 30,
    ...
    website: 'iam.edu.sn',
    email: 'admissions@iam.sn',
    whatsapp: '+221771000202',
    phone: '+221338696969',
    ...
    admission: [
      ...
      'Dossier en ligne sur iam.edu.sn',
    ],
  ...
  },
  {
    ...
    website: 'ugb.edu.sn',
    email: 'scolarite@ugb.edu.sn',
    whatsapp: '+221771000303',
    phone: '+221961211840',
    ...
    admission: [
      'Bac + inscription en ligne UGB',
      "Concours d'entrée pour certaines filières",
      'Dossier : bac, relevés, CV',
    ],
  ...
  },
  {
    id: 4,
    name: 'ESP',
    full: 'École Supérieure Polytechnique',
    district: 'Fann',
    students: '3 200',
    founded: 1964,
    hue: 280,
  ...
  },
  {
    id: 5,
    name: 'ISM',
    full: 'Institut Supérieur de Management',
    district: 'Mermoz',
    students: '6 800',
    founded: 1992,
    hue: 340,
  ...
  },
  {
    id: 6,
    name: 'Sup de Co',
    full: 'Sup de Co Dakar',
    district: 'Mermoz',
    students: '2 400',
    founded: 1992,
    hue: 200,
    address: 'Rue 10, Mermoz, Dakar',
    website: 'supcodakar.com',
    email: 'contact@supcodakar.com',
    whatsapp: '+221771000606',
    phone: '+221338641200',
  ...
  },
  {
    id: 7,
    name: 'UADB',
    full: 'Université Alioune Diop de Bambey',
    district: 'Bambey',
    students: '8 500',
    founded: 2007,
    hue: 50,
  ...
  {
    id: 8,
    name: 'Polytechnique Thiès',
    full: 'École Polytechnique de Thiès',
    district: 'Thiès',
    students: '2 100',
    founded: 1974,
    hue: 120,
    ...
    website: 'ept.sn',
    email: 'scolarite@ept.sn',
    whatsapp: '+221771000808',
    phone: '+221339510004',
...
const EVENTS = [
  {
    ...
    partner: 'Place du Souvenir',
    price: 'Gratuit',
    priceVal: 0,
    hue: 30,
    attendees: 2400,
    description:
      'Festival annuel de musique sénégalaise. Concerts en plein air, gastronomie locale.',
    featured: true,
  },
  {
    id: 2,
    ...
    partner: 'Théâtre Sorano',
    price: '15 000 CFA',
    priceVal: 15000,
    hue: 220,
    attendees: 1200,
    description: 'Concert exceptionnel avec le Super Étoile de Dakar.',
    featured: true,
  },
  {
    id: 3,
    ...
    hue: 280,
    attendees: 450,
    description: 'Tech entrepreneurs et investisseurs ouest-africains.',
  },
  {
    id: 4,
    title: 'Match ASC Jaraaf',
    cat: 'Sport',
    date: '02 juin 2026',
    time: '17:00',
    venue: 'Stade Léopold Senghor',
    partner: 'Ligue Pro Sénégal',
    price: '3 000 CFA',
    priceVal: 3000,
    hue: 160,
    attendees: 5800,
    description: 'Derby de Dakar contre Casa Sports.',
  },
  {
    id: 5,
    title: 'Théâtre - Sotigui',
    cat: 'Concert',
    date: '08 juin 2026',
    time: '20:00',
    venue: 'Théâtre Sorano',
    ...
    hue: 340,
    attendees: 380,
    description: "Pièce de théâtre primée par le festival d'Avignon.",
  },
  {
    id: 6,
    title: 'Festival Dakar Mode',
    cat: 'Festival',
    date: '14 juin 2026',
    time: '18:00',
    venue: 'Place du Souvenir',
    ...
    hue: 200,
    attendees: 1800,
    description: 'Défilés, créateurs africains, music live.',
  },
  {
    id: 7,
    title: 'Conf. Climat Sahel',
    cat: 'Conférence',
    date: '20 juin 2026',
    time: '14:00',
    venue: 'UCAD',
    ...
    hue: 50,
    attendees: 320,
    description: 'Conférence académique sur le changement climatique au Sahel.',
  },
  {
    id: 8,
    ...
    hue: 35,
    attendees: 12000,
    description: 'Combat de Modou Lô vs Balla Gaye 2.',
  },
];
...
const TRANSPORT = [
  ...
  },
  {
    ...
    rating: 4.6,
    time: 'sur RDV',
    price: 'à partir de 35 000 CFA/jour',
    phone: '+221780000010',
    hue: 215,
  },
];
...
const RESTAURANTS = [
  {
    ...
    type: 'Sénégalais',
    district: 'Fann',
    distance: '0.3 km UCAD',
    rating: 4.8,
    reviews: 142,
    price: '1 500 – 4 000 CFA',
    phone: '+221771100001',
    whatsapp: '+221771100001',
    openHours: '07:00 – 22:00',
    images: 3,
    hue: 30,
    specialites: ['Thiéboudienne', 'Yassa poulet', 'Mafé', 'Ceeb u jën'],
    description:
      "La cantine préférée des étudiants de l'UCAD. Cuisine familiale authentique, portions généreuses et prix étudiant.",
    verified: true,
    hasDelivery: true,
    tableRes: true,
  },
  {
    ...
    price: '500 – 2 500 CFA',
    phone: '+221771100002',
    whatsapp: '+221771100002',
    openHours: '06:30 – 21:00',
    images: 4,
    hue: 200,
    specialites: ['Café Touba', 'Sandwichs', 'Jus bissap', 'Croissants'],
    description: 'Café étudiant avec WiFi gratuit. Idéal pour réviser en journée.',
    verified: true,
    hasDelivery: false,
    tableRes: false,
  },
  {
    id: 3,
    name: 'Dakar Grill House',
    type: 'Grillades',
    district: 'Mermoz',
    distance: '2.0 km ISM',
    rating: 4.5,
    reviews: 63,
    price: '3 000 – 8 000 CFA',
    phone: '+221771100003',
    whatsapp: '+221771100003',
    openHours: '12:00 – 23:00',
    images: 3,
    hue: 15,
    specialites: ['Brochettes', 'Poulet DG', 'Thiof grillé', "Côtes d'agneau"],
    description: 'Le meilleur grill de Mermoz. Ambiance conviviale, terrasse extérieure.',
    verified: true,
    hasDelivery: true,
    tableRes: true,
  },
  {
    ...
    price: '800 – 2 000 CFA',
    phone: '+221771100004',
    whatsapp: '+221771100004',
    openHours: '08:00 – 23:30',
    images: 2,
    hue: 340,
    specialites: ['Chawarma', 'Burger sénégalais', 'Frites', 'Boissons'],
    description: 'Fast food rapide et pas cher. Très populaire le soir après les cours.',
    verified: false,
    hasDelivery: true,
    tableRes: false,
  },
  {
    ...
    rating: 4.9,
    reviews: 187,
    price: '2 000 – 6 000 CFA',
    phone: '+221771100005',
    whatsapp: '+221771100005',
    openHours: '11:00 – 22:30',
    images: 5,
    hue: 160,
    specialites: ['Thiéboudienne royale', 'Domoda', 'Bissap glacé', 'Pastels'],
    description: 'Restaurant gastronomique sénégalais. Déjeuner buffet le week-end.',
    verified: true,
    hasDelivery: false,
    tableRes: true,
  },
  {
    id: 6,
    name: 'Pizza da Moussa',
    type: 'Pizza & Pâtes',
    district: 'Ouakam',
    distance: '3.0 km',
    rating: 4.4,
    reviews: 54,
    price: '2 500 – 5 000 CFA',
    phone: '+221771100006',
    whatsapp: '+221771100006',
    openHours: '11:00 – 23:00',
    images: 3,
    hue: 280,
    specialites: ['Pizza berbère', 'Pizza sénégalaise', 'Pasta', 'Tiramisu'],
    description: 'Pizzeria artisanale avec four à bois. Fusion afro-italienne originale.',
    verified: true,
    hasDelivery: true,
    tableRes: true,
  },
...
const I18N = {
  fr: {
    ...
    topVerified: 'Top vérifiés',
    deals: 'Bons plans étudiants',
  ...
  wo: {
    ...
    searchPlaceholder: 'Wuti ab kër...',
    topVerified: 'Yu wóor',
    deals: 'Yu nooy ci jàngalekat',
    upcoming: 'Yi di ñëw',
    viewAll: 'Gis yépp',
    home: 'Kër',
    search: 'Wuti',
  ...
  en: {
    welcome: 'Welcome',
    searchPlaceholder: 'Search a home...',
...
const PERSONAS = {
  ...
  local: {
    name: 'Étudiant local',
    greeting: 'Bonjour 👋',
    priority: ['logements', 'news', 'transport'],
    hint: 'Bons plans et événements de la semaine',
  },
  parent: {
    name: 'Parent',
    greeting: 'Bonsoir 👋',
    priority: ['logements', 'ecoles', 'news'],
