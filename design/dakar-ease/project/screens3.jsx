...
function SchoolDetail({ school, onBack }) {
  ...
  const relatedListings = (school.logements || [])
    ...
    >
      ...
      <div
        style={{
          ...
          height: 220,
          marginTop: -62,
          background: `linear-gradient(135deg, oklch(0.55 0.18 ${school.hue}), oklch(0.35 0.2 ${school.hue + 30}))`,
          display: 'flex',
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '16px 20px 100px' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                {school.filieres.map((f) => (
                  <span
                    ...
                    style={{
                      padding: '6px 12px',
                      background: `oklch(0.95 0.04 ${school.hue})`,
                      color: `oklch(0.35 0.15 ${school.hue})`,
                      borderRadius: 20,
                      fontSize: 12,
                      fontWeight: 600,
                    }}
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81a19.79 19.79 0 01-3.07-8.7A2 2 0 012.18 1h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 8.09a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 15.92z"></path>
                  </svg>
                  Appeler
                </a>
                <a
        ...
        {tab === 'admission' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div key={i} style={{ display: 'flex', gap: 12, marginBottom: 14 }}>
                  <div
                    style={{
                      ...
                      height: 28,
                      borderRadius: '50%',
                      background: `oklch(0.55 0.18 ${school.hue})`,
                      color: '#fff',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
            ...
            >
              ...
              <div
                style={{ fontSize: 12, color: `oklch(0.4 0.12 ${school.hue})`, lineHeight: 1.6 }}
              >
                Prépare ton dossier 3 mois à l'avance. Contacte directement le service des
                admissions via WhatsApp pour avoir les dernières informations.
              </div>
            </div>
            <a
              href={`https://wa.me/${school.whatsapp.replace(/\D/g, '')}`}
        ...
        {tab === 'logements' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              relatedListings.map((l) => (
                ...
                >
                  ...
                  <div style={{ padding: '12px 14px', flex: 1 }}>
                    <div
                      style={{ fontSize: 13, fontWeight: 700, color: COLORS.text, marginBottom: 2 }}
                    >
                      {l.title}
                    </div>
                    <div style={{ fontSize: 11, color: COLORS.textLight }}>
                      {l.district} · {l.distance}
                    </div>
                    <div
                      style={{ fontSize: 14, fontWeight: 700, color: COLORS.primary, marginTop: 6 }}
                    >
                      {l.price.toLocaleString('fr-FR')}{' '}
                      <span style={{ fontSize: 10, fontWeight: 400 }}>CFA/mois</span>
                    </div>
                  </div>
                </div>
              ))
            ...
            <div
              style={{
                background: `oklch(0.95 0.03 ${school.hue})`,
                borderRadius: 14,
                padding: 14,
                textAlign: 'center',
              }}
            >
              <div style={{ fontSize: 12, color: `oklch(0.4 0.12 ${school.hue})` }}>
                Voir tous les logements proches de {school.name}
              </div>
            </div>
          </div>
        )}
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
          ...
          <h2 style={{ fontSize: 18, fontWeight: 700, margin: 0, color: COLORS.text, flex: 1 }}>
            Restaurants
          </h2>
        </div>
        <div
              ...
              <div style={{ padding: '12px 14px 14px' }}>
                ...
                >
                  ...
                  >
                    ...
                    {r.rating}{' '}
                    <span style={{ color: COLORS.textLight, fontWeight: 400 }}>({r.reviews})</span>
                  </div>
                </div>
                <div style={{ fontSize: 12, color: COLORS.textLight, marginBottom: 6 }}>
                  {r.type} · {r.district} · {r.distance}
                </div>
                <div
...
function RestaurantDetail({ restaurant, onBack }) {
  ...
  const r = restaurant;
  const priceBase =
    parseInt((r.price.match(/\d[\d\s]*/) || ['1500'])[0].replace(/\s/g, '')) || 1500;
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          >
            ...
            >
              <span style={{ color: '#F59E0B' }}>★</span>
              {r.rating}
              <span style={{ fontSize: 12, color: COLORS.textLight, fontWeight: 400 }}>
                ({r.reviews})
              </span>
            </div>
          </div>
        ...
        >
          ...
          >
                ...
                >
                  <div
                    style={{
                      ...
                      height: 48,
                      borderRadius: 12,
                      background: `oklch(0.85 0.07 ${r.hue})`,
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      fontSize: 22,
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div
                      style={{ fontSize: 12, color: COLORS.primary, fontWeight: 700, marginTop: 2 }}
                    >
                      {m.price.toLocaleString('fr-FR')} CFA
                    </div>
                  </div>
                  <button
                    style={{
            ...
            <div style={{ padding: '12px 20px 20px', borderTop: `1px solid ${COLORS.border}` }}>
              {r.hasDelivery ? (
                <a
                  href={`https://wa.me/${r.whatsapp.replace(/\D/g, '')}?text=${encodeURIComponent('Bonjour ' + r.name + ", je souhaite commander en livraison via Dakar'ease.")}`}
                  target="_blank"
                  rel="noopener"
                  style={{
                    display: 'block',
