...
C'est l'étape qui **prouve** le critère d'acceptation du prompt : *"un compte étudiant A ne peut ni lire ni modifier les données d'un compte étudiant B — à vérifier concrètement, pas supposé"*.
